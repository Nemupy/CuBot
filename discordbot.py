...
async def event(ctx, server):
    ...
    embed.add_field(
        name="**┉≪イベント概要≫┉┉┉┉┉┉┉┉┉┉┉┉┉**",
        value="> ６つのサーバーで開催される大規模イベント！\n> 各サーバーでキーワードを集めて言葉を完成させよう！\n> サーバーごとに報酬をゲット！是非クリアしよう！",
        inline=False,
    )
    embed.add_field(
        name="**┉≪イベント参加方法≫┉┉┉┉┉┉┉┉┉**",
    ...
    embed.add_field(
        name="**┉≪イベントに使用するBOT≫┉┉┉┉**",
        value="> 当イベントはBOTを用いて運営しています。\n> 不具合が発生しましたら@音夢?!#7777までご連絡ください。",
        inline=False,
    )
    if server == "jp":
        jpse = discord.Embed(title="キーワード", description="JP:registered:のキーワードは「き」です！")
        jpse.set_thumbnail(
            url="https://media.discordapp.net/attachments/855770786337783818/865920217754107924/21nHBeO4r9L.png"
        )
        await ctx.send(embed=embed)
        ...
        msese.set_thumbnail(
            url="https://media.discordapp.net/attachments/855770786337783818/866244706907586570/mojipara_9331-hs-3l.png"
        )
        await ctx.send(embed=embed)
        ...
        acese.set_thumbnail(
            url="https://media.discordapp.net/attachments/855770786337783818/866245321403400212/images.png"
        )
        await ctx.send(embed=embed)
        ...
        sinse.set_thumbnail(
            url="https://media.discordapp.net/attachments/855770786337783818/"
            "865920814108246086/xEUIIIYQQQgghhIDzA3BGFFDc73PiAAAAAElFTkSuQmCC.png"
        )
        await ctx.send(embed=embed)
        await ctx.send(embed=sinse)
    elif server == "雑談者のつどい":
        zatuse = discord.Embed(title="キーワード", description="雑談者のつどい ~Zatsudan Jp~のキーワードは「ば」です！")
        zatuse.set_thumbnail(
            url="https://media.discordapp.net/attachments/855770786337783818/866246788688248852/images.png"
        )
        await ctx.send(embed=embed)
        ...
        toyse.set_thumbnail(
            url="https://media.discordapp.net/attachments/855770786337783818/866247285146386433/images.png"
        )
        await ctx.send(embed=embed)
