...
bot = commands.Bot(command_prefix = 'Cu!', help_command = None, intents = intents)
...
async def on_ready():
    ...
    await bot.change_presence(activity=discord.Activity(name=f"Cu!help | {str(servers)} | {str(members)}, type=3))
